          ...
          dc.send(
            JSON.stringify({
              ...
              response: {
                ...
                instructions: `Thank the parent for providing the absence details and let them know you're going to process it and they will get a copy of the absence report for their own records. Do not mention the specific absence details in this message. Just be warm and personable in your farewell.
              `,
              },
            }),
          );
